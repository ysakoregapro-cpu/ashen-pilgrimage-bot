...
const TOWN_SHOP_CATALOG: Record<string, string[]> = {
  start_starfield: ['cons_heal_potion', 'cons_antidote', 'cons_smoke_bomb', 'upg_rough_stone', 'rep_patch', 'wpn_traveler_sword', 'arm_set_starfield_body'],
  old_road_village: ['cons_heal_potion', 'cons_antidote', 'upg_rough_stone', 'rep_patch', 'wpn_old_road_knife', 'arm_set_old_road_head'],
  ...
  silver_mine: ['cons_heal_medium', 'cons_antidote', 'upg_stone', 'rep_oil', 'rep_silver_clip', 'wpn_silver_hammer', 'arm_set_silver_head', 'mat_silver_ore'],
  mist_forest: ['cons_heal_medium', 'cons_antidote', 'cons_status_cure', 'upg_stone', 'rep_patch', 'acc_traveler_ring', 'acc_mist_talisman'],
  ...
  deep_furnace_outpost: ['cons_heal_large', 'cons_lamp_bottle', 'upg_rare_stone', 'upg_deep_core_stone', 'rep_deep_repair', 'cons_status_cure'],
