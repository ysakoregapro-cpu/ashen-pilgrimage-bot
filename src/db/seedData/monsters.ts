...
export const MONSTER_SEED_DATA = mons([
  ...
  { id: 'mon_drift_undead', name: '漂流亡者', tag: 'port', lv: 10, hp: 95, atk: 16, mag: 10, def: 6, spd: 6, exp: 22, gold: 14 },
  ...
  // ヴァルハラ
  { id: 'mon_old_army', name: '旧統治軍制式兵', tag: 'valhalla', lv: 58, hp: 320, atk: 42, mag: 10, def: 34, spd: 10, exp: 125, gold: 90 },
  { id: 'mon_sky_mech', name: '空塞機兵', tag: 'valhalla', lv: 60, hp: 340, atk: 44, mag: 16, def: 36, spd: 12, exp: 130, gold: 95 },
  { id: 'mon_lab_failure', name: '実験区画の失敗体', tag: 'valhalla', lv: 62, hp: 300, atk: 36, mag: 40, def: 24, spd: 14, exp: 135, gold: 98 },
  { id: 'mon_furnace_defense', name: '炉心防衛ユニット', tag: 'valhalla', lv: 64, hp: 420, atk: 36, mag: 20, def: 38, spd: 8, exp: 140, gold: 102 },
  { id: 'mon_throne_guard', name: '玉座の守護機', tag: 'valhalla', lv: 66, hp: 420, atk: 48, mag: 24, def: 42, spd: 8, exp: 145, gold: 105 },
