...
const MATERIALS: Mat[] = [
  ...
  { id: 'boss_silent_page', name: '無答の守護者の頁', cat: 'boss_material', rarity: 'UR', desc: '禁書の頁。ヴァルハラ最上位触媒。Src最終強化・UR覚醒・特性保護等に使う（多くは将来Phase）。', source: '無答の守護者・ヴァルハラボス', usage: '最上位触媒', price: 500 },
  { id: 'valhalla_emblem', name: 'ヴァルハラ徽章', cat: 'currency_material', rarity: 'UR', desc: 'ヴァルハラ周回の証。徽章交換所で高級素材・装備厳選に交換できる。', source: 'ヴァルハラボス', usage: '徽章交換', price: 10, trade: 0 },
  { id: 'mat_ur_lottery_shard', name: 'UR抽選の欠片', cat: 'boss_material', rarity: 'UR', desc: 'UR抽選箱の触媒。徽章交換所でも入手可能（将来）。', source: 'ヴァルハラボス（低確率）', usage: 'UR抽選（将来）', price: 0, trade: 0 },
  { id: 'mat_affix_reroll_assist', name: '特性再抽選の触媒', cat: 'boss_material', rarity: 'UR', desc: '防具/アクセ特性再抽選の補助素材。', source: 'ヴァルハラボス（低確率）', usage: '特性再抽選（将来）', price: 0, trade: 0 },
  { id: 'mat_affix_slot_protect', name: '特性保護の触媒', cat: 'boss_material', rarity: 'UR', desc: '特性再抽選時に1枠を保護する触媒。無答の守護者の頁と徽章で交換（将来）。', source: '徽章交換（将来）', usage: '特性1枠保護（将来）', price: 0, trade: 0 },
